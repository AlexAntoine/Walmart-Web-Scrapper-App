...
//controller methods
const {getLoginPage,getEditUserPage, getSignupPage, registerUser,loginUser, getDashboard, logOut, addUser, getRegisterPage, getAllusers, updateUser, deleteUser,changePassword, getChangePasswordPage} = require('../controller/user');
